					...
					.ajax({
						...
						success : function(result) {
							...
							if (result.success) {
										...
										.each(
												...
												function(i, user) {
													...
													tableContent += '<td>'
															...
															+ '</td>';
													tableContent += '<td>';
													tableContent += '	<button type="button" onclick="ogAssignPage('+user.id+')" class="btn btn-success btn-xs">';
													tableContent += '		<i class=" glyphicon glyphicon-check"></i>';
													tableContent += '	</button>';
													tableContent += '	<button type="button" onclick="updatePage('
															+ user.id
								...
								for (var i = 1; i <= userPage.totalNum; i++) {
									if (i == pageNum) {
